...
Fillmore is a jQuery plugin that allows you to add a dynamically-resized background image to any page.
...
Want to change the image after Fillmore has been loaded? No problem, just call it again!
...
* You can now called fillmore twice, and it will replace the existing image.
